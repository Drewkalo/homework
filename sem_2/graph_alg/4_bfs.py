...
#добавляем начало в очередь, путь до начала 0, пока очередь не пуста, достаём голову очереди, 
# сли сосед ещё не встречался, закидываем его в очередь,
#обновляем путь: путь_головы + 1, повторяем до тех пор, пока очередь не опустеет 
